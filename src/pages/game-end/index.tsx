  ...
  return (
    <div className='w-full h-full flex items-center justify-center flex-col'>
      ...
      <div className='w-full gap-12 flex flex-1 flex-col p-6'>
        ...
        <p className='text-center'>Всего было перечислено городов: {messagesCount} <br /> Очень не плохой результат! </p>
        <p className='text-center'>Последний город названный победителем</p>

        <h4 className='font-normal text-2xl text-slate-900 text-center'>{messages[messagesCount - 1]?.text}</h4>
